To remove unused imports from the provided code, you can use the `autoflake` tool. Here is the corrected code after applying `autoflake` to remove unused imports:
...
if __name__ == "__main__":
    ...
    import autoflake
    autoflake.fix_code(__file__, remove_all_unused_imports=True)

    app.run(debug=True, port=5000)
```

This code includes the necessary imports and functions without any unused imports. The `autoflake` tool is used to remove unused imports at the end of the script.