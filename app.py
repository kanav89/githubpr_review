...
def check_flake8(code):
    ...
    try:
        ...
        if report.total_errors == 0:
            ...
            results = []
            print(report._application.file_checker_manager.checkers[0].results)
            for error_code,line_number,_,error,code in report._application.file_checker_manager.checkers[0].results:
